  ...
  return (
    ...
    >
      ...
      <div aria-hidden='true' className='pointer-events-none absolute inset-0'>
        <div className="absolute inset-0 bg-[url('/assets/ornaments/grid-pattern.svg')] bg-[length:1442px_765px] bg-[position:calc(50%+110px)_top] bg-no-repeat opacity-100" />
