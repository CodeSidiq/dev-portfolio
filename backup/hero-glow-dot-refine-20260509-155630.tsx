        ...
        */}
        <div aria-hidden='true' className='absolute inset-0'>
          {HERO_GLOW_DOTS.map((dot) => (
            <span
              key={dot.id}
              className={`absolute rounded-full bg-neutral-500 transition-all duration-300 hover:scale-150 hover:bg-brand-pink hover:opacity-80 hover:shadow-[0_0_18px_rgba(220,73,166,0.65)] ${dot.className}`}
            />
          ))}
        </div>
