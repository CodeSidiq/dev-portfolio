  ...
  return (
    ...
    >
      ...
      <div aria-hidden='true' className='pointer-events-none absolute inset-0'>
        ...
        */}
        <div className='absolute top-[-120px] left-[-90px] h-[454px] w-[491px] rounded-[50%] bg-[#6831E1]/40 blur-[58px]' />
        ...
        */}
        <div className='absolute top-[-560px] right-[-760px] h-[2140px] w-[2141px] rounded-full bg-[#8243EA]/40 blur-[363px]' />
      </div>
