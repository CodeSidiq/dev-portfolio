        ...
        <div className='relative aspect-[1160/459] overflow-hidden rounded-3xl bg-[image:var(--gradient-brand)]'>
          ...
          */}
          <Image
            ...
            height={459}
            priority
            className='relative z-10 mx-auto h-full w-auto translate-x-[0px] translate-y-[30px] scale-[1.25] transform-gpu object-contain object-center md:translate-y-[75px] md:scale-[1.5]'
          />
        </div>
      </div>
    </section>
