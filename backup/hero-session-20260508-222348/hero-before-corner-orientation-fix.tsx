      ...
      <div className="relative z-10 mx-auto flex max-w-[1200px] flex-col items-center px-6">
        ...
        <h1 className="w-full max-w-[64rem] font-bold text-neutral-25 text-[clamp(2rem,5vw,3rem)] leading-tight">
          ...
          <span className="group relative inline-block">
            <span className="relative z-10 inline-block px-5 py-2 bg-[image:var(--gradient-brand)] bg-clip-text text-transparent">
            ...
            />
            <span aria-hidden="true" className="absolute left-[-0.75rem] top-[calc(50%-0.625em)] h-[0.64rem] w-[1.22rem] bg-neutral-25 shadow-[0_0_8px_rgba(220,73,166,0.45)]" />
            <span aria-hidden="true" className="absolute right-[-0.75rem] top-[calc(50%-0.625em)] h-[0.64rem] w-[1.22rem] bg-neutral-25 shadow-[0_0_8px_rgba(220,73,166,0.45)]" />
            <span aria-hidden="true" className="absolute left-[-0.75rem] bottom-[calc(50%-0.625em)] h-[0.64rem] w-[1.22rem] bg-neutral-25 shadow-[0_0_8px_rgba(220,73,166,0.45)]" />
            <span aria-hidden="true" className="absolute right-[-0.75rem] bottom-[calc(50%-0.625em)] h-[0.64rem] w-[1.22rem] bg-neutral-25 shadow-[0_0_8px_rgba(220,73,166,0.45)]" />
          </span>{' '}
