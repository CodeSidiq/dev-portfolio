  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 mx-auto mt-[-80px] max-w-[1200px] px-6'>
        <div className='bg-base-background relative aspect-[1160/459] overflow-hidden rounded-3xl'>
          <Image
            ...
            width={1160}
            height={459}
            className='absolute inset-0 h-full w-full scale-110 object-cover object-[center_28%] opacity-40 blur-2xl'
          />
          ...
          <Image
            ...
            height={459}
            priority
            className='relative z-10 mx-auto h-full w-auto translate-x-[0px] translate-y-[75px] scale-[1.5] transform-gpu object-contain object-center'
          />
        </div>
      </div>
    </section>
